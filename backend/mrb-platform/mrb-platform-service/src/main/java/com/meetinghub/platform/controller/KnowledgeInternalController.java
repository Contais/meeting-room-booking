 ...
 * <p>
 * 路径前缀 {@code /platform/internal/kb/**}，仅供服务间 Feign 调用，不经过网关。
 * </p>
 */
@RestController
@RequestMapping("/platform/internal/kb")
...
public class KnowledgeInternalController {
    ...
    @GetMapping("/search")
    public Result<List<KbEntryDTO>> search(@RequestParam("query") String query) {
