...
const query = reactive({ page: 1, size: 20, keyword: '', subject: '', contactPhone: '', status: undefined as number | undefined })
...
function resetQuery() { query.keyword = ''; query.subject = ''; query.contactPhone = ''; query.status = undefined; query.page = 1; loadData() }
