<template>
  <div class="room-list">
    ...
    <FilterTable :filters="filterDefs" :filter-model="filter" @search="applyFilter" @reset="resetFilter">
      <div class="room-grid">
...
const filter = reactive<Record<string, any>>({ keyword: '', minCapacity: undefined })

const filterDefs = [
  { prop: 'keyword', label: '搜索', type: 'input' as const, placeholder: '会议室名称/位置' },
  { prop: 'minCapacity', label: '最少人数', type: 'number' as const, min: 1, max: 1000, width: '120px' },
]
