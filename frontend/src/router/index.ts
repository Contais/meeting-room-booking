...
const routes: RouteRecordRaw[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'reservation/my-v2', name: 'MyReservationsV2', component: () => import('@/views/reservation/MyReservationsV2.vue'), meta: { title: '我的预约V2', requiresAuth: true } },
      ...
      { path: 'admin/menus-v2', name: 'AdminMenusV2', component: () => import('@/views/admin/MenuManageV2.vue'), meta: { title: '菜单管理V2', requiresAuth: true, requiresAdmin: true } },
      ...
      { path: 'admin/departments-v2', name: 'AdminDepartmentsV2', component: () => import('@/views/admin/DeptManageV2.vue'), meta: { title: '部门管理V2', requiresAuth: true, requiresAdmin: true } },
      ...
      { path: 'admin/users-v2', name: 'AdminUsersV2', component: () => import('@/views/admin/UserManageV2.vue'), meta: { title: '用户管理V2', requiresAuth: true, requiresAdmin: true } },
      ...
      { path: 'admin/reservations-v2', name: 'AdminReservationsV2', component: () => import('@/views/admin/ReservationManageV2.vue'), meta: { title: '预约管理V2', requiresAuth: true, requiresAdmin: true } },
      ...
      { path: 'admin/rooms-v2', name: 'AdminRoomsV2', component: () => import('@/views/admin/RoomManageV2.vue'), meta: { title: '会议室管理V2', requiresAuth: true, requiresAdmin: true } },
